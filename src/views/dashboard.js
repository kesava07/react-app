                ...
                <div className="container chenna">
                    <div className="col-md-12 p-0 mt-3">
                        <div class="card shadow">
                            <div class="card-body">
                                <i className="fa fa-trophy fa-2x pull-left icon-styles5"></i>
                            </div>
                        </div>
                    </div>
                    <div className="row mt-5">
                        <div className="col-md-3 ">
                            <div class="card shadow">
                                <div class="card-body">
                                    <i className="fa fa-area-chart fa-2x  icon-styles1"></i>
                                    <h2 className="mt-3"><strong>$2005</strong></h2>
                                    <h4 className="mt-3 text-secondary">Price per trip</h4>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-3 ">
                            <div class="card shadow">
                                <div class="card-body">
                                    <i className="fa fa-line-chart fa-2x  icon-styles2"></i>
                                    <h2 className="mt-3"><strong>$2005</strong></h2>
                                    <h4 className="mt-3 text-secondary">Price per trip</h4>
                                </div>
                            </div>
                        ...
                        <div className="col-md-3 ">
                            <div class="card shadow">
                                <div class="card-body">
                                    <i className="fa fa-bar-chart fa-2x icon-styles3"></i>
                                    <h2 className="mt-3"><strong>$2005</strong></h2>
                                    <h4 className="mt-3 text-secondary">Price per trip</h4>
                                </div>
                            </div>
                        ...
                        <div className="col-md-3 ">
                            <div class="card shadow">
                                <div class="card-body">
                                    <i className="fa fa-pie-chart fa-2x icon-styles4"></i>
                                    <h2 className="mt-3"><strong>$2005</strong></h2>
                                    <h4 className="mt-3 text-secondary">Price per trip</h4>
                                </div>
                            </div>
